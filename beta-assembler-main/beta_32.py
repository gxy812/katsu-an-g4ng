...
ROL = lambda RA, RB, RC: betaop(0x00, RA, RB, RC)
ROR = lambda RA, RB, RC: betaop(0x01, RA, RB, RC)
RORC = lambda RA, C, RC: betaopc(0x02, RA, C, RC)
ROLC = lambda RA, C, RC: betaopc(0x03, RA, C, RC)
ABSAC = lambda RA, C, RC: betaopc(0x04, RA, C, RC)
ABSSC = lambda RA, C, RC: betaopc(0x05, RA, C, RC)
ABSMC = lambda RA, C, RC: betaopc(0x06, RA, C, RC)
ABSA = lambda RA, RB, RC: betaop(0x07, RA, RB, RC)
ABSS = lambda RA, RB, RC: betaop(0x08, RA, RB, RC)
ABSM = lambda RA, RB, RC: betaop(0x09, RA, RB, RC)
REVAC = lambda RA, C, RC: betaopc(0x0A, RA, C, RC)
REVSC = lambda RA, C, RC: betaopc(0x0B, RA, C, RC)
REVMC = lambda RA, C, RC: betaopc(0x0C, RA, C, RC)
REVA = lambda RA, RB, RC: betaop(0x0D, RA, RB, RC)
REVS = lambda RA, RB, RC: betaop(0x0E, RA, RB, RC)
REVM = lambda RA, RB, RC: betaop(0x0F, RA, RB, RC)
